  ...
  <Dialog class="dialog-send-funds" width="70%" :value="value" @input="$emit('input', $event)">
    <div style="text-align: center;">
      ...
      <div class="text-inputs">
        <TextInput icon="fa-address-card" v-model.trim="form.address" placeholder="Send to Regius Mark address..." />
...
<script lang="ts">
import { Asset, ScriptHash, ASSET_SYMBOL, MAX_MEMO_BYTE_SIZE } from 'regiusmark';
